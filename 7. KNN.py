...
classifier = KNeighborsClassifier(algorithm='brute', n_neighbors=10, weights='uniform')
...
# Accuracy
print("Accuracy of the classifier on test set: {:.2f}%".format(classifier.score(X_test, y_test) * 100))
